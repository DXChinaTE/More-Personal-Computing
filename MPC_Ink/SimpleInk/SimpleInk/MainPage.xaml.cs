...
namespace SimpleInk
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void ScenarioControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            int index = scenarioListBox.SelectedIndex;
            switch (index)
            {
                case 0:
                    ScenarioFrame.Navigate(typeof(Scenario1));
                    break;
                case 1:
                    ScenarioFrame.Navigate(typeof(Scenario2));
                    break;
                case 2:
                    if (Windows.System.Profile.AnalyticsInfo.VersionInfo.DeviceFamily == "Windows.Mobile")
                        ScenarioFrame.Navigate(typeof(Scenario3_phone));
                    else
                        ScenarioFrame.Navigate(typeof(Scenario3));
                    break;
                case 3:
                    ScenarioFrame.Navigate(typeof(Scenario4));
                    break;
            }
        ...
        private void TextBlock_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            ScenarioFrame.Navigate(typeof(Scenario5));
            Splitter.IsPaneOpen = false;
        }
    }
}
